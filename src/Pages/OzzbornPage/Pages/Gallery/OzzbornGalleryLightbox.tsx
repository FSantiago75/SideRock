...
import { getOzzbornAdjacentPhotoId } from './ozzbornGalleryContent'
import styles from './OzzbornGalleryLightbox.module.css'

type OzzbornGalleryLightboxProps = {
...
export function OzzbornGalleryLightbox({
  photos,
  activePhotoId,
  onClose,
  onNavigate,
}: OzzbornGalleryLightboxProps) {
  ...
  const previousId = getOzzbornAdjacentPhotoId(photos, activePhotoId, -1)
  const nextId = getOzzbornAdjacentPhotoId(photos, activePhotoId, 1)
