...
- **2026-08-26**: ScrollReveal — decidir pelo rect no `.main` (CSS Columns mentia `isIntersecting`); Galeria `from="up"` com distância maior que o Resumo.
